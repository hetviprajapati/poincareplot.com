      ...
      <div className="poincare-wrap">
        ...
        <footer className="poincare-footer">
          ...
          <div className="about-disclaimer">
            ...
            <p>
              poincareplot.com, rmssd.com, hrv.live, and Time Domain Labs tools are for informational and educational purposes only. Not a
              medical device. Not FDA cleared or approved. No medical advice is provided.
            </p>
